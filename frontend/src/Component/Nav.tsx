              ...
              {!isAuthenticated ? (
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-slate-100 hover:bg-emerald-50 hover:text-emerald-600 text-slate-700 px-3 py-2 rounded-xl text-xs font-bold transition-all border border-slate-200"
                  ...
                  <button
                    ...
                    className="bg-slate-100 hover:bg-red-50 hover:text-red-600 text-slate-600 px-3 md:px-4 py-2 rounded-xl font-bold text-[10px] md:text-xs uppercase tracking-widest transition-all active:scale-95 border border-slate-200"
                  >
                    Logout
                  </button>
                </div>
            ...
            <div className="flex flex-col gap-4 text-xs font-bold uppercase tracking-widest text-slate-900 border-b border-slate-100 pb-4">
              ...
              {isAuthenticated && (
                <button
                  ...
                  className="flex items-center gap-2 text-emerald-600 font-extrabold text-left"
                >
                  <Settings size={16} />
                  Settings & Profile
                </button>
