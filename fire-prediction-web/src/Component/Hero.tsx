  ...
  return (
    <header className="relative h-screen w-full flex items-center justify-center px-6 overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[12px] -[0.2em] mb-8 uppercase">
